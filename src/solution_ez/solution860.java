...
public class solution860 {
    ...
    private boolean change(int money) {
        wallet.put(money, wallet.getOrDefault(money, 0) + 1);
        money -= 5;
        // 找20
        while (money >= 20 && wallet.getOrDefault(20, 0) > 0) {
            money -= 20;
            wallet.put(20, wallet.getOrDefault(20, 0) - 1);
        }
        // 找10
        while (money >= 10 && wallet.getOrDefault(10, 0) > 0) {
            money -= 10;
            wallet.put(10, wallet.getOrDefault(10, 0) - 1);
        }
        // 找5
        while (money >= 5 && wallet.getOrDefault(5, 0) > 0) {
            money -= 5;
