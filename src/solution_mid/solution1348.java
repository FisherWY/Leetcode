...
public class solution1348 {
    ...
    class TweetCounts {
        // 用户 -> (推文时间 -> 该时间的推文数量)
        private Map<String, TreeMap<Integer, Integer>> map = null;
        ...
        public void recordTweet(String tweetName, int time) {
            // 获取当前用户推文Map
            TreeMap<Integer, Integer> tweetMap = map.computeIfAbsent(tweetName, x -> new TreeMap<>());
            // 更新推文Map
        ...
        public List<Integer> getTweetCountsPerFrequency(String freq, String tweetName, int startTime, int endTime) {
            ...
            int start = startTime, end = Math.min(start + freqTime, endTime + 1);
            while (start <= endTime) {
                int count = 0;
                // 寻找发文时间介于start和end的推文数量
