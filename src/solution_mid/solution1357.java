...
public class solution1357 {
    ...
    class Cashier {
        ...
        public double getBill(int[] product, int[] amount) {
            ...
            if (count % n == 0) {
                res -= res * discount / 100;
            }
            return res;
        }
    }

    public Cashier getCashier(int n, int discount, int[] products, int[] prices) {
        return new Cashier(n, discount, products, prices);
    }

    public static void main(String[] args) {
        int n = 3, discount = 50;
        int[] products = {1,2,3,4,5,6,7}, prices = {100,200,300,400,300,200,100};
        solution1357 s = new solution1357();
        Cashier cashier = s.getCashier(n, discount, products, prices);
